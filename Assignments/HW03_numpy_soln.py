...
print(nparray2 == nparray2b)   # 4x3 array of all True values
print(nparray2 is nparray2b)   # False
...
#
print(f"idlabels - Type : {type(idlabels)} , Shape : {idlabels.shape}  ; Data type : {idlabels.dtype} ; Strides : {idlabels.strides}")
print(f"i - Type : {type(i)} , Shape : {i.shape}  ; Data type : {i.dtype} ; Strides : {i.strides}")
print(f"i - Type : {type(i)} , Shape : {i.shape}  ; Data type : {i.dtype} ; Strides : {i.strides}")
...
#
nparray2c = nparray2
print("Original nparray2:\n", nparray2)
print("Original nparray2c:\n", nparray2c)
print("nparray2==nparray2c : \n", nparray2==nparray2c)
print("nparray2 is nparray2c : ", nparray2 is nparray2c)
#
nparray2c[1,1] = 0
print("Afterwards nparray2:\n", nparray2)
print("Afterwards nparray2c:\n", nparray2c)
print("nparray2==nparray2c : \n", nparray2==nparray2c)
print("nparray2 is nparray2c : ", nparray2 is nparray2c)
#%%
...
print("\nThe list of values that are multiple of seven in the original array:")
print(myarray[boolarr])
...
# write your codes here
#
nparray3D = nparray4.reshape(2,3,-1)
print(nparray3D)
#
#%%
