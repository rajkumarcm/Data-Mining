...
# loc, iloc     (ix function in pandas DEPRECATED)
df = pd.DataFrame(np.random.rand(5, 4),
index = ['a','b','c','d','e'], columns = ['A', 'B', 'C', 'D'])

print(df.loc[:,'A'])
print(df.loc[:,['A','C']])
# print(df.loc[['a','b','f','h'],['A','C']])     #  DEPRECATED 
print(df.loc['a':'h'])
print(df.loc['a']>=0)
print(df.iloc[:3])
print(df.iloc[:3])
...
print(df.iloc[1:3, :])
print(df.iloc[:,1:3])
# print(df.ix[:4])    #  DEPRECATED 
# print(df.ix[:,'A'])     #  DEPRECATED 
print(df[['A','B']])
print(df.A)
print('#',50*"-")
...
#%%
# Importing 
mb = pd.read_csv("nfl2008_fga.csv")
print(mb)
print(mb.head())
mb = pd.read_csv("nfl2008_fga.csv", header=None)
print(mb.head())
mb = pd.read_table("nfl2008_fga.csv", sep=',')
print(mb.head())
mb = pd.read_csv("nfl2008_fga.csv", index_col=['GameDate','HomeTeam'])
print(mb.head())
pd.read_csv("nfl2008_fga.csv", nrows=4)
print(mb.head())
pd.read_csv("nfl2008_fga.csv").head(20)
print(mb.head())
print('#',50*"-")
